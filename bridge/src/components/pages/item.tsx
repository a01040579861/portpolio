...
const Item = () => {
  ...
  return (
    <>
      ...
      <section
        id="section1"
        className="w-full h-screen mt-6 flex flex-col justify-center items-center bg-[var(--main)] text-[var(--light)] px-6"
      >
      ...
      <section className="h-full w-screen mb-6 overflow-hidden">
        ...
        >
          <div className="panel w-screen h-screen flex items-center justify-center bg-[var(--main)] text-[var(--sub)] text-5xl font-bold">
            Slide 1
          </div>
          <div className="panel w-screen h-screen flex items-center justify-center bg-[var(--main)] text-[var(--sub)] text-5xl font-bold">
            Slide 2
